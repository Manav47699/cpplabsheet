...
class rupees{
    ...
    public:
        ...
        friend bool operator>(rupees, dollars);                                                      // Overloading all opeartors
...
bool operator>(dollars d, rupees r){                                                               // Overloading for comparing dolalrs to rupees
